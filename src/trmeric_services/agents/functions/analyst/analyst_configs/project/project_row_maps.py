...
ROW_MAPPINGS = [
    {"name": "portfolio", "columns": ["portfolio_id_id"], "data": portfolio_data, "args": ["tenant_id"], "type": "exact", "description": "This is a mapping of portfolio IDs to portfoliio names for this tenant."},
]
